...
router.delete('/deleteTask/:taskId', auth, canManageProjectTasks, validate(deleteTaskSchema), deleteTask)
router.put('/updateTask/:taskId', auth, canUpdateTask, validate(updateTaskSchema), updateTask)
router.get('/getUserTasks/:projectId', auth, validate(getUserTasksSchema), getUserTasks)
